...
pub mod customer_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_customer(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ihavefood.CustomerService/CreateCustomer",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ihavefood.CustomerService", "CreateCustomer"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod delivery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_rider(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateRiderRequest>,
        ) -> std::result::Result<tonic::Response<super::Rider>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/ihavefood.DeliveryService/CreateRider",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ihavefood.DeliveryService", "CreateRider"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod delivery_service_server {
    ...
    pub trait DeliveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_rider(
            &self,
            request: tonic::Request<super::CreateRiderRequest>,
        ) -> std::result::Result<tonic::Response<super::Rider>, tonic::Status>;
    }
    /// ---------------------DELIVERY SERVICE---------------------------
    /// Manages riders and delivery process.
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/ihavefood.DeliveryService/CreateRider" => {
                    #[allow(non_camel_case_types)]
                    struct CreateRiderSvc<T: DeliveryService>(pub Arc<T>);
                    impl<
                        T: DeliveryService,
                    > tonic::server::UnaryService<super::CreateRiderRequest>
                    for CreateRiderSvc<T> {
                        type Response = super::Rider;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DeliveryService>::create_rider(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateRiderSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
