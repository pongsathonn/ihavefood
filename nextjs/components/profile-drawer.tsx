...
import { ChevronLeft, Mail, Phone, User, Facebook, Instagram, MessageCircle, MapPin, Plus, LogOut } from "lucide-react"
                ...
                <section className="w-full p-4 md:p-6 space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">Manage your profile and saved addresses</p>
                        </div>
                    </div>
                        ...
                        <CardContent className="pt-8 pb-6">
                            <div className="flex flex-col items-center">
                                <Avatar className="h-24 w-24 border-4 border-slate-50 mb-4 shadow-sm">
                                    ...
                                    <AvatarFallback className="bg-slate-200 text-slate-600 text-xl">FC</AvatarFallback>
                                </Avatar>
                                <h3 className="text-xl font-bold text-slate-900">FooCustomer</h3>
                            ...
                            <div className="mt-8 space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center px-2">
                                        ...
                                        <Button variant="link" size="sm" className="text-blue-600 h-auto p-0">Edit</Button>
                                    </div>

                                    <div className="grid gap-4 bg-slate-50/50 p-4 rounded-2xl border border-slate-100">
                                        <div className="flex items-center gap-3">
                                            <User className="h-4 w-4 text-slate-400" />
                                            <span className="text-sm text-slate-500 w-24">Customer ID</span>
                                            <span className="text-sm font-medium text-slate-900">#TODO-12345</span>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            <Mail className="h-4 w-4 text-slate-400" />
                                            <span className="text-sm text-slate-500 w-24">Email</span>
                                            <span className="text-sm font-medium text-slate-900">TODO@example.comasodijasd</span>
                                        </div>
                                        <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex justify-end gap-2 px-2">
                                        <Button variant="ghost" size="sm" className="rounded-xl text-slate-500">Cancel</Button>
                                        <Button size="sm" className="rounded-xl bg-slate-900 hover:bg-slate-800 px-6">Save</Button>
                                    </div>
                                </div>
