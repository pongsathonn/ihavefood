...
export function BrowsePage() {
    ...
    return (
        <div className="h-[80vh] bg-gradient-to-r from-slate-900 to-slate-700 rounded-b-3xl">
            ...
            <header id="main-header" className="flex items-stretch relative col-span-1 md:col-span-3 h-[15vh]">

                <div className="w-full md:w-[20%] h-[8vh] self-start flex items-center justify-center md:justify-start px-6">
                ...
                <div className="hidden md:flex flex-[3] h-full items-center justify-center px-4">
                    {/* PENDING -> PREPARING -> FINDING_RIDER -> WAIT_PICKUP -> DELIVERED */}
                    <div className="w-full">
                        <LiveActivity />
                    </div>
                </div>

                <div className="hidden md:flex h-[8vh] self-start items-center justify-end shrink-0">
                    ...
                    <div className="pr-14 justify-center">
                        <IconButton
                            icon="tracking"
                            showBadge={false}
                            isDisabled={isOrder === true}
                            onClick={() => {
                                setIsOrder(true);
                                setShowOrderTracking(true);
                            }}
                        />
                        {showOrderTracking && <FakeTracking />}
                    </div> */}
                </div>
            </header >
