...
// OrderService handle status for order
 ...
 | Order      | order    | order.placed.event        | restaurant queue | Restaurant |    "       | 
 | Restaurant | order    | food.cooking.event        | order queue      | Order      | PREPARE    | after restaurant accepted order
 | Restaurant | order    | food.cooking.event        | delivery queue   | Delivery   |    "       | start delivery assignemnt (notify to rider)
